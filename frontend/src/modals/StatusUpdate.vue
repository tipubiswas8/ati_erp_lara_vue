...
const openResponseNotification = (placement: NotificationPlacement, response: { responseStatus: boolean, responseUserName: string }) => {
        ...
        h(
          Button,
          {
            ...
            onClick: async () => {
              ...
              try {
                const response = await axios.patch('http://localhost:8000/api/user-status2', {
                  id: userData.id,
